...
import { sendExpirationReminderEmail } from "../email/mailer.js";

/**
 * Factory: demo 到期处理和定时检查
 */
export function createDemoExpirationService(deps) {
  const {
  ...
  return { expireDemos, runExpirationCheck, isExpired };
}
