...
describe("deployment steps", () => {
  it("createDeploymentSteps creates 9 steps", () => {
  ...
  it("completeDeploymentSteps fills context and marks pending as skipped", () => {
    ...
    assert.strictEqual(completed.length, 9);
  ...
  it("failedDeploymentSteps adds failed event", () => {
    ...
    assert.ok(failed.length > 9, "should add failed event");
...
describe("deploymentJobStatusLabel", () => {
  it("returns Chinese labels", () => {
    assert.strictEqual(svc.deploymentJobStatusLabel("queued"), "????");
    assert.strictEqual(svc.deploymentJobStatusLabel("running"), "????");
    assert.strictEqual(svc.deploymentJobStatusLabel("success"), "???");
    assert.strictEqual(svc.deploymentJobStatusLabel("failed"), "????");
    assert.strictEqual(svc.deploymentJobStatusLabel("unknown"), "????");
  });
});
