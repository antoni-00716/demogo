// DemoGo v0.9.6 ? CLI core (thin wrapper around shared module)
...
// Configure shared module for CLI identity
configureShared({ userAgentPrefix: "demogo-cli", version: VERSION });
