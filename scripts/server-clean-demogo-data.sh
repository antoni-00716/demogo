...
rm -rf /var/www/demo
find /tmp -maxdepth 1 -type f -name 'demogo-server-v*.zip' ! -name 'demogo-server-v0.2.3.zip' -delete
find /tmp -maxdepth 1 -type f -name 'demogo-ops-scripts-v*.zip' ! -name 'demogo-ops-scripts-v0.2.3.zip' -delete
